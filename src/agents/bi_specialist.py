...
j) Gunakan "NEEDS_REVIEW" HANYA jika klausa relevan dengan topik BI tetapi pasal yang ditemukan tidak cukup untuk memutuskan status (ambigu atau konteks tidak lengkap) sehingga perlu tinjauan auditor manusia. Jangan gunakan NEEDS_REVIEW bila salah satu status lain dapat ditentukan.
k) Gunakan "UNCLEAR" HANYA jika teks klausa itu sendiri tidak dapat dipahami (terpotong, rusak, atau tidak lengkap) sehingga tidak dapat diklasifikasikan.
